...
V1.5.0 是首个面向外部用户的正式版本，V1.5.1 是当前正式热修版。此前版本继续保留为内部演进与审计历史，不覆盖、不改写。V1.5.1 一键安装会把旧版和重复副本移出活动插件搜索路径，在搜索路径外保留一个回滚快照，并在验收后把其余旧副本移入系统回收站，避免旧 Hook 被再次选中。
...
| 历史版本 | `V1.0`、`V1.1`、`V1.2`、`V1.3`、`V1.3.1`、`V1.3.1.1`、`V1.3.1.2`、`V1.3.1.3`、`V1.3.1.4`、`V1.4.0`、`V1.4.1`、`V1.4.2`、`V1.4.3`、`V1.4.4`、`V1.4.5`、`V1.4.6`、`V1.4.7`、`V1.4.8`、`V1.4.9`、`V1.5.0` | 仅保留在历史 Release、迁移脚本、审计和测试中；不覆盖既有产物 |
