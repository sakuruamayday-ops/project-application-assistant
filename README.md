...
<p align="center">
  <a href="docs/releases/V1.6.20.md"><img src="https://img.shields.io/badge/Release-V1.6.20-C9A760?style=for-the-badge" alt="Release V1.6.20"></a>
...
V1.6.20 完整保留财税报告计算与来源条目，超过单页容量时自动续页，按实际生成页数验收；继续保留确定性计算、专业交付有界收束和独立客户端同源技能投影。客户端与技能包分别版本化、分别验收，正式状态以 GitHub Latest 与受控发布回执为准。
...
| [V1.6.20 功能简介](docs/releases/V1.6.20.md) | 财税报告计算与来源完整保留、自动续页和实际页数验收 |
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.6.20` | 本次发布版本；GitHub、受控门户和本机活动技能按同一签名事务同步 |
