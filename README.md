...
<p align="center">
  <a href="https://github.com/sakuruamayday-ops/project-application-assistant/releases/tag/V1.6.1"><img src="https://img.shields.io/badge/Release-V1.6.1-C9A760?style=for-the-badge" alt="Release V1.6.1"></a>
  ...
  <a href="docs/releases/V1.6.1.md"><img src="https://img.shields.io/badge/Release%20Channel-Verified-2F7D5C?style=for-the-badge" alt="Verified release channel"></a>
...
V1.6.1 是当前对外发布的唯一最新版本。它增加人才创业落地区域预评估、企业身份血缘与主题反查，并把服务器活动发布槽统一收敛为当前版和上一版。企业数字身份证与知识索引继续作为独立的服务端数据门禁，不进入插件包。
...
| [V1.6.1 发布说明](docs/releases/V1.6.1.md) | 当前版本变更、兼容性和已知限制 |
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.6.1` | 网站、GitHub Release 和用户可见最新版 |
| 组件版本 | `1.6.1` | 套件、插件和 Python 组件版本 |
