...
<p align="center">
  <a href="https://github.com/sakuruamayday-ops/project-application-assistant/releases/tag/V1.5.5"><img src="https://img.shields.io/badge/Release-V1.5.5-C9A760?style=for-the-badge" alt="Release V1.5.5"></a>
  ...
  <a href="docs/releases/V1.5.5.md"><img src="https://img.shields.io/badge/Release%20Channel-Verified-2F7D5C?style=for-the-badge" alt="Verified release channel"></a>
...
V1.5.5 是当前对外发布的唯一最新版本。它修复 Windows WorkBuddy Hook 执行器兼容问题，向管理员和普通成员展示只读历史版本，并从三首产品名称与小巨人来源行业分类动态扩充中文主题词典。

### WorkBuddy 平台说明

WorkBuddy的系统差异由两个独立签名包内的极薄 Hook 启动适配器处理，macOS 使用 Shell，Windows 由宿主 PortableGit Bash 运行最小桥接脚本后进入原生 CMD。安装完成标准统一为：49项Skills可识别，新消息轮次不继承上一轮Skill，`tools/list`出现`knowledge_search`、`knowledge_document`、`knowledge_service_status`，并实际调用状态工具返回`connected: true`。
...
| [V1.5.5 发布说明](docs/releases/V1.5.5.md) | 当前版本变更、兼容性和已知限制 |
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.5.5` | 网站、GitHub Release 和用户可见最新版 |
| 组件版本 | `1.5.5` | 套件、插件和 Python 组件版本 |
