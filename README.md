...
<p align="center">
  <a href="https://github.com/sakuruamayday-ops/project-application-assistant/releases/tag/V1.6.0"><img src="https://img.shields.io/badge/Release-V1.6.0-C9A760?style=for-the-badge" alt="Release V1.6.0"></a>
  ...
  <a href="docs/releases/V1.6.0.md"><img src="https://img.shields.io/badge/Release%20Channel-Verified-2F7D5C?style=for-the-badge" alt="Verified release channel"></a>
...
V1.6.0 是当前对外发布的唯一最新版本。它把 Grounded 证据交付、前期培育方向卡和专利规则纳入统一 Skills 套件，并保持企业数字身份证与知识索引为独立的服务端数据门禁。
...
| [V1.6.0 发布说明](docs/releases/V1.6.0.md) | 当前版本变更、兼容性和已知限制 |
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.6.0` | 网站、GitHub Release 和用户可见最新版 |
| 组件版本 | `1.6.0` | 套件、插件和 Python 组件版本 |
