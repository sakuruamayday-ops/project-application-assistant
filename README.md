...
<p align="center">
  <a href="https://github.com/sakuruamayday-ops/project-application-assistant/releases/tag/V1.3.1.3"><img src="https://img.shields.io/badge/Release-V1.3.1.3-C9A760?style=for-the-badge" alt="Release V1.3.1.3"></a>
  ...
  <a href="docs/releases/V1.3.1.3.md"><img src="https://img.shields.io/badge/Signature-Ed25519-2F7D5C?style=for-the-badge" alt="Ed25519 signed"></a>
...
| [V1.3.1.3 发布说明](docs/releases/V1.3.1.3.md) | 当前版本变更、兼容性和已知限制 |
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.3.1.3` | 网站、GitHub Release 和用户可见版本 |
| 组件版本 | `1.3.1.3` | 套件、插件和 Python 组件版本 |
| 数据规则版本 | 独立命名 | 例如 `policy-cluster-v1.0.0`，不代表产品版本 |
| 历史版本 | `V1.0`、`V1.1`、`V1.2`、`V1.3`、`V1.3.1`、`V1.3.1.1`、`V1.3.1.2` | 仅保留在历史 Release、迁移脚本、审计和测试中 |
