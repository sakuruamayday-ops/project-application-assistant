...
<p align="center">
  <a href="https://github.com/sakuruamayday-ops/project-application-assistant/releases/tag/V1.4.6"><img src="https://img.shields.io/badge/Release-V1.4.6-C9A760?style=for-the-badge" alt="Release V1.4.6"></a>
  ...
  <a href="docs/releases/V1.4.6.md"><img src="https://img.shields.io/badge/Release%20Channel-Verified-2F7D5C?style=for-the-badge" alt="Verified release channel"></a>
...
| [V1.4.6 发布说明](docs/releases/V1.4.6.md) | 当前版本变更、兼容性和已知限制 |
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.4.6` | 网站、GitHub Release 和用户可见版本 |
| 组件版本 | `1.4.6` | 套件、插件和 Python 组件版本 |
