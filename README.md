...
V1.6.16 已正式发布绿色工厂自评价报告的版本识别、基本要求阻断、评分证据矩阵、指标边界和附件索引，并已通过独立技能更新源供 V0.4.1 客户端验签激活；客户端与技能包继续分别版本化、分别验收。
...
| 层级 | 当前值 | 说明 |
|---|---|---|
| 产品标签 | `V1.6.16` | 当前正式版本；GitHub、受控门户、本机活动技能和客户端独立更新源已同步 |
| 组件版本 | `1.6.16` | 套件、插件和 Python 组件版本 |
