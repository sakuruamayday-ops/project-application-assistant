...
ROUTES = {
    "comprehensive": ("jiaotang-patent-router", ["P1", "P2", "P3"]),
    "search": ("jiaotang-patent-router", ["P1"]),
    "patentability": ("jiaotang-patent-router", ["P1"]),
    "claims": ("jiaotang-patent-router", ["P1"]),
    "fto": ("jiaotang-patent-router", ["P1"]),
