...
from safe_temp import PersistentTemporaryDirectory
...
def calc_dpi_via_pdf(input_path: str, max_w_px: int, max_h_px: int, verbose: bool) -> int:
    ...
    _default_macos_tmpdir_for_soffice()
    with PersistentTemporaryDirectory(prefix="soffice_profile_") as user_profile:
        with PersistentTemporaryDirectory(prefix="soffice_convert_") as convert_tmp_dir:
