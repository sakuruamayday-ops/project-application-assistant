...
市场占有率和排名必须说明分子、分母、细分市场、地域、期间和来源。涉及细分市场排名或冠军类项目时，必须调用 `industry-positioning`，完整读取其细分市场边界与产业链价值证据闸门，并将分类、测算、对标企业和证据状态写入 `evidence-ledger`。项目分类和证据等级见 `references/quality-brand-taxonomy.md`。
