...
def build_cover(document: Document) -> None:
    ...
    add_callout(
        document,
        "先记住三件事",
        "管理器版本与 Skills 内容版本相互独立。当前管理器为 0.2.0，正式 Skills 仍为 V1.3.1.2，共 49 项。"
...
def build_security_page(document: Document) -> None:
    ...
    add_bullets(
        document,
        [
            "管理器“关于”或安全中心显示版本 0.2.0，Skills 清单显示 V1.3.1.2 与 49 项。",
...
def build_document() -> Document:
    ...
    properties.comments = "正式用户手册，适用管理器 0.2.0 与 Skills V1.3.1.2"
