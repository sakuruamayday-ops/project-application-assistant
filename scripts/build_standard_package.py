...
REQUIRED = [
    ...
    *PORTABLE_REPORT_REQUIRED,
    ...
    "skills/jiaotang-patent-router/scripts/patent_case_manifest.py",
    "skills/jiaotang-patent-router/scripts/build_patent_application.py",
    "skills/jiaotang-patent-router/references/patent-application-delivery-contract.json",
    "skills/jiaotang-patent-router/requirements.txt",
