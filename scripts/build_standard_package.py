...
PORTABLE_REPORT_REQUIRED = [
    ...
    "skills/_runtime/gongchuang-branding/runtime-manifest.json",
    "skills/_runtime/gongchuang-branding/requirements.txt",
    ...
    "skills/_runtime/gongchuang-branding/assets/brand-gold-10.png",
    "skills/_runtime/gongchuang-branding/assets/brand-gold-12.png",
    "skills/_runtime/gongchuang-branding/assets/brand-gold-16.png",
    "skills/_runtime/gongchuang-branding/assets/brand-red-07.png",
    "skills/_runtime/gongchuang-branding/assets/brand-red-10.png",
    "skills/_runtime/gongchuang-branding/assets/brand-red-12.png",
    "skills/_runtime/gongchuang-branding/assets/brand-red-16.png",
    "skills/_runtime/gongchuang-branding/assets/brand-white-10.png",
    "skills/_runtime/gongchuang-branding/assets/brand-white-16.png",
]
...
REQUIRED = [
    ...
    *PORTABLE_REPORT_REQUIRED,
    ...
    "skills/legal-regulations/scripts/search_legal_base.py",
    ...
    "skills/patent-router/scripts/build_ipc_evidence_chain.py",
    "skills/patent-router/scripts/build_claim_prior_art_matrix.py",
    "skills/patent-router/scripts/claim_structure.py",
    "skills/patent-router/scripts/patent_case_manifest.py",
    "skills/patent-router/scripts/build_patent_application.py",
    "skills/patent-router/references/patent-application-delivery-contract.json",
    "skills/patent-router/requirements.txt",
    "skills/patent-router/references/ipc-snapshots/manifest.json",
